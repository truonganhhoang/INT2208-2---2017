...
Scenario: Tôi chọn mục "So sánh phép tính"
    Given Tôi đang ở màn hình trang chủ hiển thị các phần chơi
    When Tôi bấm nút "Bắt đầu" của mục "So sánh phép tính"
    Then Màn hình trang chủ chuyển sang màn hình của minigame "So sánh phép tính"

Scenario: Tôi chọn mục "Chọn các số hạng"
    Given Tôi đang ở màn hình trang chủ hiển thị các phần chơi
    When Tôi bấm nút "Bắt đầu" của mục "Chọn các số hạng"
    Then Màn hình trang chủ chuyển sang màn hình của minigame "Chọn các số hạng"

Scenario: Tôi chọn mục "Luyện trí nhớ"
    Given Tôi đang ở màn hình trang chủ hiển thị các phần chơi
    When Tôi bấm nút "Bắt đầu" của mục "Luyện trí nhớ"
    Then Màn hình trang chủ chuyển sang màn hình của minigame "Luyện trí nhớ"
